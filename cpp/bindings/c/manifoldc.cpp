...
#include "meshbool/manifoldc.h"

#include <vector>

#include "conv.h"
#include "meshbool/common.h"
#include "meshbool/cross_section.h"
#include "meshbool/manifold.h"
#include "meshbool/polygon.h"
#include "meshbool/types.h"
...
ManifoldMeshGL* manifold_meshgl(void* mem, float* vert_props, size_t n_verts,
  ...
  mesh->vertProperties = manifold::VecView(vert_props, n_verts * n_props);
  mesh->triVerts = manifold::VecView(tri_verts, n_tris * 3);
  return to_c(mesh);
}
