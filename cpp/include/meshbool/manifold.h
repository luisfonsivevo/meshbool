...
class MeshGLP {
 ...
 public:
  inline MeshGLP(MeshGLType&& i)
    ...
    this->internal = MeshGLType(i.clone());
  }
...
class Manifold {
 ...
 public:
  ...
  inline Manifold(rust::crate::MeshBool&& i) : internal() {
    this->internal = rust::crate::MeshBool(i.clone());
  }
  ...
  inline Manifold(const MeshGL& mesh) {
    this->internal = rust::crate::MeshBool::from_meshgl(mesh.internal.clone());
  }
  inline Manifold(const MeshGL64& mesh) : internal() {
    this->internal =
        rust::crate::MeshBool::from_meshgl64(mesh.internal.clone());
  }
  // TODO: originally negative 1?
  inline MeshGL GetMeshGL(int normalIdx = 0) const {
    return this->internal.get_mesh_gl(normalIdx);
  }
  inline MeshGL64 GetMeshGL64(int normalIdx = 0) const {
  ...
  inline static Manifold Sphere(double radius, int circularSegments = 0) {
    // return Manifold(rust::crate::MeshBool::sphere(radius, circularSegments));
    // TODO
    throw "fail";
    return Manifold();
  }
  ...
  inline Manifold Translate(vec3 v) const {
    return this->internal.translate(
        ::rust::nalgebra::Point3<::double_t>::new_(v.x, v.y, v.z));
  }
  ...
  inline Manifold Mirror(vec3) const {
    // TODO
    throw "fail";
    // return this->internal.mirror();
    return Manifold();
  }
  inline Manifold Transform(const mat3x4&) const {
    // TODO
    throw "fail";
  ...
  inline Manifold Warp(std::function<void(vec3&)> f) const {
    // return this->internal.warp();
    // TODO
    throw "fail";
    return Manifold();
  }
  inline Manifold WarpBatch(std::function<void(VecView<vec3>)>) const {
    // TODO
    throw "fail";
    return Manifold();
  }
  ...
  inline std::pair<Manifold, Manifold> Split(const Manifold&) const {
    // TODO
    throw "fail";
    return std::pair(Manifold(), Manifold());
  }
   ...
   */
  ///@{
  inline Manifold Refine(int) const {
    // TODO
    throw "fail";
    return Manifold();
  }
  inline Manifold RefineToLength(double) const {
    // TODO
    throw "fail";
    return Manifold();
  }
  inline Manifold RefineToTolerance(double) const {
    // TODO
    throw "fail";
    return Manifold();
  }
 ...
 */
  ...
  inline bool MatchesTriNormals() const {
    // TODO
    throw "fail";
    // return this->internal.get_epsilon();
    return false;
  }
