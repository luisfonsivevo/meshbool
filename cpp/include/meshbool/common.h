...
class Quality {
 private:
 public:
  inline static void SetMinCircularAngle(double angle) {
    // TODO
  }
  inline static void SetMinCircularEdgeLength(double length) {
    // TODO
  }
  inline static void SetCircularSegments(int number) {
    // TODO
  }
  inline static int GetCircularSegments(double radius) {
    // TODO
    return DEFAULT_SEGMENTS;
  }
  inline static void ResetToDefaults() {
    // TODO
  }
};
/** @} */
